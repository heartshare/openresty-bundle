...
class HttpResponseHeaders : public ::google::protobuf::MessageLite {
 public:
  ...
  inline void set_allocated_reason_phrase(::std::string* reason_phrase);
...
inline void HttpResponseHeaders::clear_reason_phrase() {
  if (reason_phrase_ != &::google::protobuf::internal::GetEmptyString()) {
...
inline ::std::string* HttpResponseHeaders::release_reason_phrase() {
  ...
  if (reason_phrase_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    reason_phrase_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
inline void HttpResponseHeaders::set_allocated_reason_phrase(::std::string* reason_phrase) {
  if (reason_phrase_ != &::google::protobuf::internal::GetEmptyString()) {
    delete reason_phrase_;
  }
  if (reason_phrase) {
    set_has_reason_phrase();
...
inline void HttpRequestHeaders::clear_message_body() {
  if (message_body_ != &::google::protobuf::internal::GetEmptyString()) {
    message_body_->clear();
  }
...
inline ::std::string* HttpRequestHeaders::release_message_body() {
  ...
  if (message_body_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    message_body_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
